...
custom_local_manifest = ".repo/local_manifests/venom_manifest.xml"
custom_default_revision = "pie"
custom_dependencies = "venom.dependencies"
org_manifest = "VenomProject-Devices"  # leave empty if org is provided in manifest
org_display = "VenomProject-Devices"  # needed for displaying
